...
export default function Testimonials() {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div className="bg-#FF7F5C-100 px-6 lg:p-4 flex flex-col lg:flex-row justify-around items-center w-64 h-56 ml-8 lg:m-none lg:h-full lg:w-full rounded-lg shadow-lg">
            ...
            <div className='w-full lg:w-1/2 py-4 text-gray-600'>
              <p className="text-lg">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='w-8' fill='#FF7F5C'>
              ...
              <p className="text-lg text-#FF7F5C-600 font-bold">- Alex Beats</p>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-#FF7F5C-100 px-6 lg:p-4 flex flex-col lg:flex-row justify-around items-center w-64 h-56 ml-8 lg:m-none lg:h-full lg:w-full rounded-lg shadow-lg">
            ...
            <div className='w-full lg:w-1/2 py-4 text-gray-600'>
              ...
              <p className="text-lg text-#FF7F5C-600 font-bold">- Jamie Wave</p>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-#FF7F5C-100 px-6 lg:p-4 flex flex-col lg:flex-row justify-around items-center w-64 h-56 ml-8 lg:m-none lg:h-full lg:w-full rounded-lg shadow-lg">
            ...
            <div className='w-full lg:w-1/2 py-4 text-gray-600'>
              ...
              <p className="text-lg text-#FF7F5C-600 font-bold">- Sam Rhythm</p>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-#FF7F5C-100 px-6 lg:p-4 flex flex-col lg:flex-row justify-around items-center w-64 h-56 ml-8 lg:m-none lg:h-full lg:w-full rounded-lg shadow-lg">
            ...
            <div className='w-full lg:w-1/2 py-4 text-gray-600'>
              ...
              <p className="text-lg text-#FF7F5C-600 font-bold">- Taylor Melody</p>
            </div>
          </div>
        </SwiperSlide>
      </Swiper>
